...
!function () {
    ...
    s = function () {
        ...
        function n(i, n) {
            if (!("object" == (typeof i === "undefined" ? "undefined" : _typeof(i)) && i instanceof Element)) throw new Error("Invalid argument provided to upgrade MDL element.");
            var a = t(i),
                l = [];
...
module.exports = __webpack_require__.p + "online-therapy.html";
